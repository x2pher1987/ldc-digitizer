...
/* ============================================================================
   LOCAL RUNTIME SHIM
   This file was authored as a Claude.ai artifact, which provides `window.storage`
   (a small per-artifact KV store) for free. Running it as a normal Vite app, we
   back that same interface with localStorage so every call site below (save/
   load/list/delete lot records) works unmodified.
   ========================================================================== */
